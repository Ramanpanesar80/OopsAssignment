...
public class ComputerStoreDriver {
	 public static final int MAX_COMPUTERS = 100;
	    ...
	    public static int addComputers(Scanner scanner, int maxComputers, Computer[] inventory, int passwordAttempts, String password) {
	        ...
	        if (numComputersToAdd <= (maxComputers - countComputers(inventory))) {
	            ...
	            System.out.println("Not enough space in inventory. You can only add " + (maxComputers - countComputers(inventory)) + " more computers.");
	        }
